    ...
    if(isset($_POST['sumbit-login'])){
        ...
        if($userCount>0){
         ...
         if($result['role']=="admin"){
            ...
            echo "<div class='alert alert-danger'>you are user not</div>";
         }
        }else{
...
<div class="container">
    <div class="row">
        <div class="col-md-12 mt-5">
            <a class="btn btn-primary text-center px-5" href="loginuser.php">Login user</a>
            <h2 class="text-center">Admin Login&#128525</h2>
