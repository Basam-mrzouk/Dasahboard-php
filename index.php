...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="includs/includs/assets/css/animate.css">
...
<body>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><a href="Admin/login.php">LognAmin</a></li>
    <li><a href="Admin/loginuser.php">LognUser</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-5 offset-lg-1">
          <div class="owl-banner owl-carousel">
            <div class="item">
              <img src="includs/assets/images/banner-01.png" alt="">
            </div>
            <div class="item">
              <img src="includs/assets/images/banner-02.png" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="categories">
            <div class="row">
              ...
              <div class="col-lg-2 col-sm-6">
                <div class="item">
                  <div class="icon">
                    <img src="includs/assets/images/icon-01.png" alt="">
                  </div>
                  <h4>Blockchain</h4>
              ...
              <div class="col-lg-2 col-sm-6">
                <div class="item">
                  <div class="icon">
                    <img src="includs/assets/images/icon-03.png" alt="">
                  </div>
                  <h4>Music Art</h4>
                  <div class="icon-button">
                    <a href="#"><i class="fa fa-angle-right"></i></a>
              ...
              <div class="col-lg-2 col-sm-6">
                <div class="item">
                  <div class="icon">
                    <img src="includs/assets/images/icon-05.png" alt="">
                  </div>
                  <h4>Valuable</h4>
                  <div class="icon-button">
                    <a href="#"><i class="fa fa-angle-right"></i></a>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="owl-collection owl-carousel">
                  <div class="item">
                    <img src="includs/assets/images/collection-01.jpg" alt="">
            ...
            <div class="col-lg-6 currently-market-item all msc">
              <div class="item">
                <div class="left-image">
                  <img src="includs/assets/images/market-01.jpg" alt="" style="border-radius: 20px; min-width: 195px;">
                </div>
                <div class="right-content">
                  <h4>Music Art Super Item</h4>
                  <span class="author">
                    <img src="includs/assets/images/author.jpg" alt="" style="max-width: 50px; border-radius: 50%;">
 ...
 <!-- Bootstrap core JavaScript -->
  ...
  <script src="includs/assets/js/isotope.min.js"></script>
  <script src="includs/assets/js/owl-carousel.js"></script>

  <script src="includs/assets/js/tabs.js"></script>
  <script src="includs/assets/js/popup.js"></script>
  <script src="includs/assets/js/custom.js"></script> 
