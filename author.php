  ...
  <div class="author-page">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="author">
            <img src="includs/assets/images/single-author.jpg" alt="" style="border-radius: 50%; max-width: 170px;">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="item">
            <div class="row">
              <div class="col-lg-12">
                <span class="author">
                  <img src="includs/assets/images/author-03.jpg" alt="" style="max-width: 50px; border-radius: 50%;">
                </span>
